...
public:
	 ...
	 * масштабе 1 на зоне 10×10 м её просто не видно: «дым зажжён», а на экране
	 * пусто. 4–5 — купол читается на всю зону.
	 */
	 ...
	 * всплеск эвакуации висели в мире вечно. Деактивация

...
public:
	 ...
	 *
	 * 0 — отключить надбавку: «стреляй, если можешь, откуда стоишь».
	 */
...
public:
	...
	/**
	 * Предлагает выстрел по КАЖДОЙ доступной цели, а не только по
 ...
 *  - «не разрешено стрелять» (лимит атакующих исчерпан) → полный

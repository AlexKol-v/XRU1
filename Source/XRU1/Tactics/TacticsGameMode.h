 ...
 *  - собрать юнитов карты по TeamId (1 = отряд, 2 = враги) и запустить бой;
 *  - применить сложность из сейва к врагам (HP/aim, отсев MinDifficulty-акторов,
 *    таймер ходов при наличии бомбы) — GDD §10;

 ...
 * одними фоновыми задачами завершается сразу — прогон 2026-08-04 дал 101 472
 * перезапуска дерева и реплики, звучавшие по кругу. StateTree остаётся для
...
struct XRU1_API FMissionVoiceLine
{
	 ...
	 * превращает их в шум — это и был главный дефект первого прогона.
	 */

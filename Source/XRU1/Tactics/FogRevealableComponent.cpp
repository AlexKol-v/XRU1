...
void UFogRevealableComponent::AddScriptedRevealHold()
{
	...
	if (ScriptedRevealHolds == 1)
	{
		...
		// и без этой строки в журнал попадала прошлая, уже неверная причина —
		// в прохождении 2026-08-03 это дало строку «ПОКАЗАН (сценарно неактивен)»,
		// то есть журнал утверждал прямо противоположное тому, что произошло.

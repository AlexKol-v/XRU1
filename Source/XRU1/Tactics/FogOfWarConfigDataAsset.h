 ...
 * и `UFogOfWarSubsystem`; сетка только рисует их результат (docs/03_ARCHITECTURE.md §8).
...
public:
	 ...
	 * как квадрат на земле. На 100 см квадраты читаются с любого зума, поэтому
	 * клетка мельче тайла XCOM. Ещё мельче — квадратично

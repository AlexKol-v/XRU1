...
> **⚠️ АРХИВ (2026-07-21): задачи выполнены.** Файл исторический. Актуальный статус — `12_GAMEPLAY_STATUS.md`.
...
> «Выполни docs/10_SONNET_MCP_TASKS.md». После выполнения агент проставляет
...
## Задача 4 — Class Defaults юнитов (этап B из 08_HUD_TODO)
...
## Задача 5 — HUD над головой (этап C из 08_HUD_TODO §5) — ОПЦИОНАЛЬНО
...
## Задача 6 — хоткеи (этап D из 08_HUD_TODO §6)
...
Финальный PIE-прогон по чеклисту `09_TACTICAL_HUD_GUIDE.md §7` (пункты про

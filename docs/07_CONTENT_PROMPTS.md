...
имена по конвенции `T_<Что>_<Вариант>` (05_WORKFLOW.md §6).
...
(проигрывание и типовые поломки — [03_ARCHITECTURE.md §11](03_ARCHITECTURE.md)). Опционально тем же способом:

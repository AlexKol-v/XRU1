...
| `UTacticsGameInstance` / `UTacticsSaveGame` | кампания: сложность, `CompletedMissions`, travel; глобальная ссылка `UITheme` | `StartNewCampaign`, `Save/LoadCampaign`, `TravelToHub/ToMainMenu`, `GetUITheme` |

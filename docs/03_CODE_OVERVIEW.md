...
Снимок на 2026-07-21. **Кодовая база закрывает весь GDD** — дальше работа
в редакторе (см. `04_ROADMAP.md` этапы 2+) и отработка геймплея
(`09_GAMEPLAY_STATUS.md`). Историю сборки HUD см. `archive/`.

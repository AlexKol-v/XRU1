...
> Родственные файлы: чеклист этапа — `08_HUD_TODO.md`, состав HUD — GDD §9,
...
- [ ] **Кнопка «Огонь»** → клик по врагу — выстрел (то же, что прямой ЛКМ);
  клик по земле — режим тихо снялся.
- [ ] Прямой ЛКМ по врагу стреляет и без кнопки.
...
Готово → проставь чекбоксы в `08_HUD_TODO.md` (шаг 4) и `04_ROADMAP.md`
(этап 6, пункт WBP_TacticalHUD).

...
- [x] Камера XCOM (C++, 2026-07-16): плавный полёт/следование за бегущим бойцом
  ...
  на отряд без выбора
- [x] Юниты влияют на навмеш (C++, 2026-07-16): капсула = динамическое
  препятствие (NavArea_Null), пути/зоны/превью огибают юнитов; у действующего
  вырез снимается. Требует RecastNavMesh Runtime Generation = **Dynamic**

...
8. **Фланг определяется ФИЗИКОЙ ВЫСТРЕЛА, а не углом к стене.** XCOM оперирует
   ...
   **Наша модель (2026-07-24):** укрытие против стрелка = толстый луч от цели в
   сторону **фактической огневой позиции стрелка** (с учётом выглядывания) на
   высотах half/full. Работает стена — есть укрытие; луч проходит мимо — фланг.
   Никаких углов и порогов.
   ...
   «фланг или нет». `CoverArcHalfAngle` остался только для отрисовки
   приблизительного сектора в дебаге.
